...
/**
 * Read a property graph from Neo4j and write RDF 1.2 (N-Triples) using reification.
 * Uses streaming export for large graphs (YAGO-scale).
 * <p>
 * Argument: output file path (default: {@code wynik-roundtrip-42.nt}).
 */
public class PropertyGraphToRdf12App {

    public static void main(String[] args) throws Exception {
        Path outPath = args.length >= 1 ? Paths.get(args[0]) : Paths.get("wynik-roundtrip-42.nt");
        ...
        try (StreamingNeo4jToRdf12Exporter exporter = StreamingNeo4jToRdf12Exporter.create(
            ...
            System.err.println("Done. Asserted: " + stats.asserted + ", reification blocks: " + stats.blocks);
        }
    }
}
